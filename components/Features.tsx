  ...
  return (
    <section className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-white/5 bg-black/20">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Rosetas?</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {features.map((feature, index) => (
          ...
          >
            <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 bg-${feature.color === 'rose' ? 'neon-rose' : 'neon-purple'}/10 text-${feature.color === 'rose' ? 'neon-rose' : 'neon-purple'} group-hover:scale-110 transition-transform`}>
